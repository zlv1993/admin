...
public class PermissionVo {
    ...
    public PermissionVo(int id, int pid, String url, String path, String component, String name, String icon, int type, Date createTime, Date updateTime, List<Role> roles) {
        this.id = id;
        this.pid = pid;
        this.url = url;
        this.path = path;
